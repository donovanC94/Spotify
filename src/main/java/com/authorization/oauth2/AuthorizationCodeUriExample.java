...
import com.authorization.other.RandomString;
...
public class AuthorizationCodeUriExample {
    ...
    private static final URI redirectUri = SpotifyHttpManager.makeUri("http://localhost:8080/token");
...
//          .show_dialog(true)
    ...
    public static void authorizationCodeUri_Sync() throws Exception {
        ...
        System.out.println("Enter code to get access token:");
